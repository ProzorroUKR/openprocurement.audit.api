...
class InspectionsListingResourceTest(BaseWebTest):
    ...
    def test_get(self):
        ...
        self.assertEqual(response.content_type, "application/json")
        self.assertEqual(
            response.json["data"], [{"dateModified": "2018-01-01T11:00:00+02:00", "id": self.inspection_id}]
        )
    ...
    def test_post_inspection_sas_empty_body(self):
        ...
        self.assertEqual({("body", "data")}, set(get_errors_field_names(response, "Data not available")))
    ...
    def test_post_inspection_sas(self):
        ...
        with mock.patch(
            ...
            response = self.app.post_json(
                "/inspections",
                {"data": {"monitoring_ids": ["f" * 32, "e" * 32, "d" * 32], "description": "Yo-ho-ho"}},
                status=201,
            )
