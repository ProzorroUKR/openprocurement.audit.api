...
class MonitoringActiveEliminationResourceTest(MonitoringEliminationBaseTest):
    ...
    def test_fail_post_elimination_report_when_not_in_addressed_state(self):
        self.app.authorization = ("Basic", (self.broker_name, self.broker_pass))
        request_data = {"description": "Five pint, six pint, seven pint, flour."}
        response = self.app.put_json(
            "/monitorings/{}/eliminationReport?acc_token={}".format(self.monitoring_id, self.tender_owner_token),
            {"data": request_data},
            status=422,
...
class MonitoringEliminationResourceTest(MonitoringEliminationBaseTest):
    ...
    def test_get_elimination(self):
        self.app.get("/monitorings/{}/eliminationReport".format(self.monitoring_id), status=403)
    ...
    def test_fail_update_resolution(self):
        ...
        assert response.json == {
            ...
            "errors": [
                {
                    "description": "Can't post eliminationResolution without eliminationReport "
                    "earlier than 5 business days since conclusion.datePublished",
                    "location": "body",
                    "name": "data",
                }
            ],
    ...
    def test_success_post_resolution_without_report(self):
        ...
        allow_post_since = calculate_normalized_business_date(parse_date(conclusion_published), RESOLUTION_WAIT_PERIOD)
...
class UpdateEliminationResourceTest(MonitoringEliminationBaseTest):
    ...
    def test_forbidden_patch(self):
        ...
        self.app.patch_json(
            "/monitorings/{}/eliminationReport".format(self.monitoring_id), {"data": request_data}, status=405
        )
    ...
    def test_forbidden_put(self):
        ...
        self.assertEqual(
            ...
            [{"description": "Can't post another elimination report.", "location": "body", "name": "data"}],
        )
    ...
    def test_forbidden_without_token_post_document(self):
        ...
        self.app.post_json(
            "/monitorings/{}/eliminationReport/documents".format(self.monitoring_id), {"data": document}, status=403
        )
    ...
    def test_patch_document_forbidden(self):
        ...
        self.app.patch_json(
            "/monitorings/{}/eliminationReport/documents/{}".format(self.monitoring_id, doc_to_update["id"]),
            {"data": document},
            status=403,
        )
    ...
    def test_fail_update_resolution_wo_result_by_type(self):
        ...
        self.assertEqual(response.json["errors"][0]["description"], {"resultByType": ["This field is required."]})
