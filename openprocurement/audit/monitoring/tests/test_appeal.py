...
class MonitoringAppealResourceTest(BaseAppealTest):
    def test_fail_patch_appeal_before_added(self):
        ...
        self.assertEqual(
            response.json["errors"], [{"location": "body", "name": "data", "description": "Appeal not found"}]
        )
...
class MonitoringAppealPostedResourceTest(BaseAppealTest):
    ...
    def test_fail_update_appeal(self):
        ...
        self.assertEqual(
            response.json["errors"], [{"location": "body", "name": "data", "description": "Can't post another appeal."}]
        )
