...
from openprocurement.audit.monitoring.utils import apply_patch, op_resource, set_author, upload_objects_documents
from openprocurement.audit.monitoring.validation import validate_appeal_data, validate_patch_appeal_data


@op_resource(
    name="Monitoring Appeal", path="/monitorings/{monitoring_id}/appeal", description="Appeal to the conclusion"
)
class AppealResource(APIResource):
    ...
    def put(self):
        ...
        self.LOGGER.info(
            "Updated appeal {}".format(self.request.context.id),
    ...
    def patch(self):
        ...
        self.LOGGER.info(
            "Updated appeal {}".format(monitoring.id),
