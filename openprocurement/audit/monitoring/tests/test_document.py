...
class MonitoringDecisionDocumentResourceTest(BaseWebTest, DSWebTestMixin):
    ...
    def test_document_get_single(self):
        ...
        response = self.app.patch_json(
            "/monitorings/{}".format(self.monitoring_id), {"data": self.test_monitoring_activation_data}
        )
    ...
    def test_document_download(self):
        ...
        response = self.app.get(
            "/monitorings/{}/decision/documents/{}?download=some_id".format(self.monitoring_id, document_id), status=404
        )
        ...
        response = self.app.get(
            "/monitorings/{}/decision/documents/{}?download={}".format(self.monitoring_id, document_id, key)
        )
...
class MonitoringPostActiveDocumentResourceTest(BaseWebTest, DSWebTestMixin):
    ...
    def test_document_get_single(self):
        self.app.authorization = ("Basic", (self.sas_name, self.sas_pass))
        response = self.app.post_json("/monitorings/{}/posts".format(self.monitoring_id), {"data": self.post_data})
        self.assertEqual(response.status_code, 201)
        self.assertEqual(response.content_type, "application/json")
        ...
        response = self.app.get(
            "/monitorings/{}/posts/{}/documents/{}".format(self.monitoring_id, post_id, document_id)
        )
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.content_type, "application/json")
    ...
    def test_document_download(self):
        ...
        response = self.app.get(
            "/monitorings/{}/posts/{}/documents/{}?download=some_id".format(self.monitoring_id, post_id, document_id),
            status=404,
        )
        self.assertEqual(response.status_code, 404)
        self.assertEqual(response.content_type, "application/json")
        ...
        response = self.app.get(
            "/monitorings/{}/posts/{}/documents/{}?download={}".format(self.monitoring_id, post_id, document_id, key)
        )
        self.assertEqual(response.status_code, 302)
        self.assertIn("http://localhost/get/", response.location)
        self.assertIn("Signature=", response.location)
    ...
    def test_document_upload(self):
        ...
        response = self.app.post_json(
            "/monitorings/{}/posts/{}/documents".format(self.monitoring_id, post_id),
            {"data": self.test_docservice_document_data},
        )
        self.assertEqual(response.status_code, 201)
        self.assertEqual(response.content_type, "application/json")
...
class MonitoringDocumentResourceTest(BaseWebTest, DSWebTestMixin):
    def setUp(self):
        ...
        self.app.patch_json(
            "/monitorings/{}".format(self.monitoring_id),
            {"data": {"status": "cancelled", "cancellation": {"description": "text"}}},
        )
    ...
    def test_document_download(self):
        ...
        response = self.app.get(
            "/monitorings/{}/documents/{}?download=some_id".format(self.monitoring_id, document_id), status=404
        )
        self.assertEqual(response.status_code, 404)
        self.assertEqual(response.content_type, "application/json")
        self.assertEqual(response.json["status"], "error")
        ...
        response = self.app.get("/monitorings/{}/documents/{}?download={}".format(self.monitoring_id, document_id, key))
        self.assertEqual(response.status_code, 302)
        self.assertIn("http://localhost/get/", response.location)
        self.assertIn("Signature=", response.location)
        self.assertIn("KeyID=", response.location)
    ...
    def test_document_upload(self):
        ...
        response = self.app.post_json(
            "/monitorings/{}/documents".format(self.monitoring_id), {"data": self.test_docservice_document_data}
        )
        self.assertEqual(response.status_code, 201)
        self.assertEqual(response.content_type, "application/json")
...
class MonitoringCancellationDocumentResourceTest(BaseWebTest, DSWebTestMixin):
    def setUp(self):
        ...
        self.test_monitoring_activation_data = {
            "status": "cancelled",
            "cancellation": {"description": "text", "documents": []},
        }
    ...
    def test_document_download(self):
        ...
        response = self.app.get(
            "/monitorings/{}/cancellation/documents/{}?download=some_id".format(self.monitoring_id, document_id),
            status=404,
        )
        self.assertEqual(response.status_code, 404)
        self.assertEqual(response.content_type, "application/json")
        ...
        response = self.app.get(
            "/monitorings/{}/cancellation/documents/{}?download={}".format(self.monitoring_id, document_id, key)
        )
        self.assertEqual(response.status_code, 302)
        self.assertIn("http://localhost/get/", response.location)
        self.assertIn("Signature=", response.location)
...
class MonitoringEliminationResolutionDocumentResourceTest(MonitoringEliminationBaseTest):
    ...
    def test_document_download(self):
        ...
        response = self.app.get(
            "/monitorings/{}/eliminationResolution/documents/{}?download=some_id".format(
                self.monitoring_id, document_id
            ),
            status=404,
        )
        self.assertEqual(response.status_code, 404)
        ...
        response = self.app.get(
            "/monitorings/{}/eliminationResolution/documents/{}?download={}".format(
    ...
    def test_patch_document(self):
        ...
        response = self.app.patch_json(
            "/monitorings/{}/eliminationResolution/documents/{}".format(self.monitoring_id, doc_to_update["id"]),
            {"data": request_data},
        )
...
class MonitoringConclusionDocumentResourceTest(BaseWebTest, DSWebTestMixin):
    ...
    def test_document_get_single(self):
        self.app.authorization = ("Basic", (self.sas_name, self.sas_pass))
        response = self.app.patch_json(
            "/monitorings/{}".format(self.monitoring_id), {"data": self.test_monitoring_addressed_data}
        )
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.content_type, "application/json")
    ...
    def test_document_patch(self):
        ...
        response = self.app.patch_json(
            "/monitorings/{}/conclusion/documents/{}".format(self.monitoring_id, doc_id),
