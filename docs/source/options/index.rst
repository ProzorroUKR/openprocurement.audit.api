...
For GET requests, options are specified as URL
parameters prefixed with `opt_`.

Example:

.. include:: http/listing-with-options-query-params.http
    :code:
...
.. include:: http/listing-with-options.http
    :code:
