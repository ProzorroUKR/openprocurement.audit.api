...
class ActiveMonitoringConclusionResourceTest(BaseWebTest, DSWebTestMixin):
    ...
    def test_fail_empty(self):
        response = self.app.patch_json(
            "/monitorings/{}".format(self.monitoring_id), {"data": {"conclusion": {}}}, status=422
        )
        self.assertEqual(
    ...
    def test_success_minimal(self):
        ...
        response = self.app.put_json(
            "/monitorings/{}/conclusion/documents/{}".format(self.monitoring_id, doc_data["id"]),
            {"data": request_data},
        )
    ...
    def test_success_violation_other(self):
        ...
        self.assertEqual(
            response.json["data"]["conclusion"]["otherViolationType"], data["conclusion"]["otherViolationType"]
        )
    ...
    def test_success_full(self):
        ...
        response = self.app.patch_json(
            "/monitorings/{}".format(self.monitoring_id), {"data": {"conclusion": conclusion}}
        )
        self.assertEqual(response.status_code, 200)
        self.assertIn("conclusion", response.json["data"])
    ...
    def test_visibility(self):
        ...
        self.app.authorization = ("Basic", (self.sas_name, self.sas_pass))
        self.app.patch_json("/monitorings/{}".format(self.monitoring_id), {"data": {"status": ADDRESSED_STATUS}})
    ...
    def test_conclusion_endpoint(self):
        ...
        self.assertEqual(
            set(response.json["data"].keys()), {"dateCreated", "description", "violationOccurred", "violationType"}
        )
    ...
    def test_conclusion_party_create_party_id_not_exists(self):
        ...
        response = self.app.patch_json(
            "/monitorings/{}".format(self.monitoring_id),
            {"data": {"conclusion": {"violationOccurred": False, "relatedParty": "Party with the devil"}}},
            status=422,
        )
