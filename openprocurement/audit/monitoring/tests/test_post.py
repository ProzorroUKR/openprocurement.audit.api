...
class MonitoringPostResourceTest(BaseWebTest, DSWebTestMixin):
    ...
    def test_post_create_required_fields(self):
        self.app.authorization = ("Basic", (self.sas_name, self.sas_pass))
        response = self.app.post_json("/monitorings/{}/posts".format(self.monitoring_id), {"data": {}}, status=422)
    ...
    def test_post_create_by_monitoring_owner(self):
        ...
        response = self.app.post_json("/monitorings/{}/posts".format(self.monitoring_id), {"data": request_data})
        ...
        response = self.app.put_json(
            "/monitorings/{}/posts/{}/documents/{}".format(self.monitoring_id, post_id, doc_data["id"]),
            {"data": request_data},
        )
        self.assertEqual(response.json["data"]["title"], request_data["title"])
        self.assertEqual(
    ...
    def test_post_create_by_tender_owner(self, mock_api_client):
        ...
        response = self.app.post_json(
            ...
            {"data": {"title": "Lorem ipsum", "description": "Lorem ipsum dolor sit amet"}},
        )
        self.assertEqual(response.status_code, 201)
        self.assertEqual(response.content_type, "application/json")
    ...
    def test_monitoring_owner_answer_post_by_monitoring_owner(self):
        ...
        response = self.app.post_json(
            "/monitorings/{}/posts".format(self.monitoring_id),
            {"data": {"title": "It’s a trap!", "description": "Enemy Ships in Sector 47!", "relatedPost": post_id}},
            status=422,
        )
        self.assertEqual(response.content_type, "application/json")
        self.assertEqual(
    ...
    def test_monitoring_credentials_tender_owner(self, client_class_mock):
        ...
        self.app.patch_json(
            "/monitorings/{}/credentials?acc_token={}".format(self.monitoring_id, "another_token"), status=403
        )
    ...
    def test_monitoring_owner_answer_post_by_tender_owner(self, mock_api_client):
        ...
        response = self.app.post_json(
            "/monitorings/{}/posts?acc_token={}".format(self.monitoring_id, tender_owner_token),
            {"data": {"title": "Lorem ipsum", "description": "Gotcha", "relatedPost": post_id}},
        )
    ...
    def test_monitoring_owner_answer_post_by_tender_owner_multiple(self, mock_api_client):
        ...
        self.assertEqual(
            ("body", "posts", "relatedPost"), next(get_errors_field_names(response, "relatedPost must be unique."))
        )
    ...
    def test_monitoring_owner_answer_post_for_not_unique_id(self, mock_api_client):
        ...
        with mock.patch(
            "openprocurement.audit.monitoring.models.uuid4", mock.Mock(return_value=mock.Mock(hex="f" * 32))
        ):
            self.app.post_json(
                "/monitorings/{}/posts".format(self.monitoring_id),
                {
    ...
    def test_answer_to_non_existent_question(self):
        response = self.app.post_json(
            "/monitorings/{}/posts".format(self.monitoring_id),
            {"data": {"title": "Lorem ipsum", "description": "Gotcha", "relatedPost": "some_non_existent_id"}},
            status=422,
        )
        self.assertEqual(response.content_type, "application/json")
        self.assertEqual(
    ...
    def test_two_answers_in_a_row(self, mock_api_client):
        ...
        response = self.app.post_json(
            "/monitorings/{}/posts?acc_token={}".format(self.monitoring_id, tender_owner_token),
            {"data": {"title": "It's a trap!", "description": "Enemy Ships in Sector 47!", "relatedPost": answer_id}},
            status=422,
        )
        self.assertEqual(response.content_type, "application/json")
        self.assertEqual(
    ...
    def test_dialogue_party_create(self):
        self.app.authorization = ("Basic", (self.sas_name, self.sas_pass))
        response = self.app.post_json(
            "/monitorings/{}/parties".format(self.monitoring_id), {"data": self.initial_party}
        )
    ...
    def test_dialogue_party_create_party_id_not_exists(self):
        ...
        self.assertEqual(
            ("body", "relatedParty"), next(get_errors_field_names(response, "relatedParty should be one of parties."))
        )
    ...
    def test_restricted_visibility(self):
        ...
        self.app.post_json("/monitorings/{}/posts".format(self.monitoring_id), {"data": request_data})
...
class DeclinedMonitoringPostResourceTest(BaseWebTest, DSWebTestMixin):
    ...
    def test_post_answer_by_monitoring_owner(self, mock_api_client):
        ...
        response = self.app.post_json(
            ...
            {"data": {"title": "Lorem ipsum", "description": "Lorem ipsum dolor sit amet", "relatedPost": post_id}},
        )
        self.assertEqual(response.status_code, 201)
        self.assertEqual(response.content_type, "application/json")
